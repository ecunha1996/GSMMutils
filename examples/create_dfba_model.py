...
def remove_pigments(model):
    ...
    model.set_stoichiometry("e_Pigments_no_car_chl_lut__cytop", "C08601__chlo", 0)

    model.set_stoichiometry("e_Pigments_no_car_chl_lut__cytop", "C08614__chlo", -1.0633)
    model.set_stoichiometry("e_Pigments_no_car_chl_lut__cytop", "C05433__chlo", -0.0256)
    model.set_stoichiometry("e_Pigments_no_car_chl_lut__cytop", "C06098__chlo", -0.0164)
    model.set_stoichiometry("e_Pigments_no_car_chl_lut__cytop", "C08591__chlo", -0.1660)

    model.set_stoichiometry("e_Pigments_no_car_chl_lut__cytop", "C08606__chlo", -0.0032)
    ...
    model.set_stoichiometry("e_Pigments_no_car_chl_lut__cytop", "C20484__chlo", -0.4527)

    model.set_stoichiometry("e_ActiveBiomass__cytop", "e_Acid__cytop", -0.0170)
