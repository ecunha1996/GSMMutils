...
# from ExpAlgae.utils.utils import enable_print, block_print
...
#         """
#
#         protected_reactions = ['e_Biomass__cytop']
#
#         return [[reaction for reaction, score in data_map.get_scores().items()
#                  if (score is not None and score > threshold) or reaction in protected_reactions]]
#
...
#     block_print()
#
#     parameters = {'threshold': threshold, 'reconstruction_wrapper': reconstruction_wrapper, 'algorithm': algorithm, "flux_threshold": 1e-9}
#
...
#
#
# def reconstruct_context_specific_models(model_template: cobra.Model, integration_result_dict: dict, details: list):
#     """
...
#
#             cobra.io.write_sbml_model(temp_model, 'omics/%s_%s.xml'
#                                       % (sample, details[1]))
#
#
#
# def integration_pipeline(dataset: pd.DataFrame, dataset_name:str, algorithm: str, threshold: float, thread_number: int, model: MyModel):
#     """
...
#
#     directories = {'Troppo_results': './omics/%s_t%s.csv'  % (integration_details[1], integration_details[2])}
#
...
#     reconstruct_context_specific_models(model, result, integration_details)
#
#
#
