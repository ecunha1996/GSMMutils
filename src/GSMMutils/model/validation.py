...
def check_energy_producing_cycles(model, atpm_reaction="ATPm__cytop", cytoplasm_abb="__cytop"):
    ...
    for met in energy_metabolites:
        ...
        new_reaction.add_metabolites(
            {copy_model.metabolites.get_by_id(met[0] + cytoplasm_abb): -1, copy_model.metabolites.C00001__cytop: -1, copy_model.metabolites.get_by_id(met[1] + cytoplasm_abb): 1, copy_model.metabolites.C00009__cytop: 1, copy_model.metabolites.C00080__cytop: 1})
        copy_model.add_reactions([new_reaction])
