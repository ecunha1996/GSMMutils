...
from ExpGSMM.dynamic.drhs import get_dynamic_expressions
from ExpGSMM.dynamic.exchange_fluxes import get_exchange_fluxes
import sympy as sp
from sympy import Max, Min
from sympy.functions import Abs
from ExpGSMM.graphics.plot import plot_concentrations
...
def get_kinetic_variables():
    ...
    return {"X": X, "F": F, "nitrate": nitrate, "phosphorus": phosphorus, "starch": starch, "starch_concentration": starch_concentration, "chlorophyll": chlorophyll, "carotene": carotene,
            "n_quota": n_quota, "p_quota": p_quota, "tag": tag, "glycerol": glycerol, "light": light}
